...
for dset in nusiance FIR; do
	...
	-adiff2 3 2 D-P \\
	-adiff3 1 3 TD-D \\
	-fa Condition \\" > /home/despoB/kaihwang/TRSE/TDSigEI/Group/ANOVA_MTD_${dset}.sh
	...
	for s in $(/bin/ls -d 5*); do
		...
		for ROI in PPA; do
			...
			for condition in HF Hp FH; do
				cbrik=$(3dinfo -verb /home/despoB/TRSEPPI/TDSigEI/${s}/${dset}_MTD_BC_stats_REML+tlrc | grep "MTD_${condition}_${ROI}-VC#0_Coef" | grep -o ' #[0-9]\{1,3\}' | grep -o '[0-9]\{1,3\}')
				echo "-dset ${c} ${n} /home/despoB/TRSEPPI/TDSigEI/${s}/${dset}_MTD_BC_stats_REML+tlrc[${cbrik}] \\" >> /home/despoB/kaihwang/TRSE/TDSigEI/Group/ANOVA_MTD_${dset}.sh
				c=$(($c+1))
			done
		done
	...
	echo "-bucket ANOVA_MTD_PPA_${dset}.nii.gz" >> /home/despoB/kaihwang/TRSE/TDSigEI/Group/ANOVA_MTD_${dset}.sh
...
for dset in nusiance FIR; do
	...
	-adiff2 3 2 D-P \\
	-adiff3 1 3 TD-D \\
	-fa Condition \\" > /home/despoB/kaihwang/TRSE/TDSigEI/Group/ANOVA_BC_${dset}.sh
	...
	for s in $(/bin/ls -d 5*); do
		...
		for ROI in PPA; do
			c=1
			for condition in HF Hp FH; do
				cbrik=$(3dinfo -verb /home/despoB/TRSEPPI/TDSigEI/${s}/${dset}_MTD_BC_stats_REML+tlrc | grep "BC_${condition}_${ROI}#0_Coef" | grep -o ' #[0-9]\{1,3\}' | grep -o '[0-9]\{1,3\}')
				echo "-dset ${c} ${n} /home/despoB/TRSEPPI/TDSigEI/${s}/${dset}_MTD_BC_stats_REML+tlrc[${cbrik}] \\" >> /home/despoB/kaihwang/TRSE/TDSigEI/Group/ANOVA_BC_${dset}.sh
				c=$(($c+1))
			done
		done
	...
	echo "-bucket ANOVA_BC_PPA_${dset}.nii.gz" >> /home/despoB/kaihwang/TRSE/TDSigEI/Group/ANOVA_BC_${dset}.sh
