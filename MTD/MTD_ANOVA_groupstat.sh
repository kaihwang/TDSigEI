...
for dset in nusiance FIR; do
	...
	for s in $(/bin/ls -d 5*); do
		...
		for ROI in FFA; do
			...
			for condition in FH Fp HF; do
				...
				echo "-dset ${r} ${c} ${n} /home/despoB/TRSEPPI/TDSigEI/${s}/${dset}_MTD_BC_stats_REML+tlrc[${cbrik}] \\" >> /home/despoB/kaihwang/TRSE/TDSigEI/Group/ANOVA_MTD_${dset}.sh
				c=$(($c+1))
			done
		done
	...
	echo "-bucket ANOVA_MTD_${dset}.nii.gz" >> /home/despoB/kaihwang/TRSE/TDSigEI/Group/ANOVA_MTD_${dset}.sh
...
for dset in nusiance FIR; do
	...
	for s in $(/bin/ls -d 5*); do
		...
		for ROI in FFA; do
			...
			for condition in FH Fp HF; do
				...
				echo "-dset ${r} ${c} ${n} /home/despoB/TRSEPPI/TDSigEI/${s}/${dset}_MTD_BC_stats_REML+tlrc[${cbrik}] \\" >> /home/despoB/kaihwang/TRSE/TDSigEI/Group/ANOVA_BC_${dset}.sh
				c=$(($c+1))
			done
		done
	...
	echo "-bucket ANOVA_BC_${dset}.nii.gz" >> /home/despoB/kaihwang/TRSE/TDSigEI/Group/ANOVA_BC_${dset}.sh
