...
spcorr = np.loadtxt('/home/despoB/kaihwang/bin/TDSigEI/Data/SpatialCorr_df.csv',delimiter=',',skiprows=1)
...
enhanceStd = [np.std(repEn_ffa), np.std(repEn_ppa)]/ np.sqrt(28)
suppressStd = [np.std(repSup_ffa), np.std(repSup_ppa)]/np.sqrt(28)
